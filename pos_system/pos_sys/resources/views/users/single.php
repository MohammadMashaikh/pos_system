    ...
    <div class="card container" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="/users" class="btn btn-outline-success">Back</a>
            <a href="/users/edit?id=<?= $data->user->id ?>" class="btn btn-outline-warning">Edit</a>
            <a href="/users/delete?id=<?= $data->user->id ?>" class="btn btn-outline-danger">Delete</a>
