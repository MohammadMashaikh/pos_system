   ...
   <div class="card container" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="/items" class="btn btn-outline-success">Back</a>
            <a href="/items/edit?id=<?= $data->item->id ?>" class="btn btn-outline-warning">Edit</a>
            <a href="/items/delete?id=<?= $data->item->id ?>" class="btn btn-outline-danger">Delete</a>
