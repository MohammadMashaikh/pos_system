<form action="/items/update" method="POST" enctype="multipart/form-data" id="create_form" class="w-50 container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="available_quantity" name="available_quantity"
            value="<?= $data->item->available_quantity ?>">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" id="item-price" name="selling_price" value="<?= $data->item->selling_price ?>">
    </div>
