...
<div class="row">
    <div class="col-lg-8 col-md-12 w-100" style=" margin-bottom:5rem; opacity: 90%;">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($data->top_five_expensive as $item) : ?>
                            <tr>
                                <td><img src="<?= $item->image ?>" style="width: 50px;height: 50px; border-radius: 30px;" alt=""></td>
                                <td><?= $item->item_name ?></td>
                                <td><?= $item->available_quantity ?></td>
                                <td><?= $item->selling_price ?></td>
                                <td><?= $item->item_cost ?></td>
                                <td><a href="./item?id=<?= $item->id ?>" class="btn btn-outline-info">Check item</a></td>
