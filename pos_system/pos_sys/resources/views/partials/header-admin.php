...
<body class="admin-view">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown" style="margin-left: 60rem;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="/user?id=<?= $_SESSION['user']['user_id'] ?>"><i class="fa-regular fa-user me-2"></i>View Profile
                            </a>
                        </li>

                            <li>

                                <a class="dropdown-item" href="/logout"><i class="fa-solid fa-right-from-bracket me-2"></i>Logout
                                </a>
    ...
    <section id="side-bar">
        <div>
            ...
            <?php endif;
            if (Helper::check_permission(['sales:read'])) :
            ?>
